    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="text-sm text-sage-dark hover:text-sage border-b border-sage-dark hover:border-sage transition-colors duration-200">
        ...
        <div class="text-center pt-6 border-t border-gray-100">
            <p class="text-sm text-gray-600">
                ¿No tienes cuenta?
                <a href="{{ route('register') }}" class="text-sage-dark hover:text-sage border-b border-sage-dark hover:border-sage transition-colors duration-200 ml-1">
                    Regístrate aquí
                </a>
            </p>
        </div>
