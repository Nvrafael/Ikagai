        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex space-x-12">
                    ...
                    <a href="#nutricionista" class="text-sm text-black border-b border-black transition-colors duration-200">
                        Nutricionista
                    </a>
                    <a href="{{ route('services.index') }}" class="text-sm text-gray-600 hover:text-black transition-colors duration-200">
                        Servicios
                    </a>
                    <a href="#contacto" class="text-sm text-gray-600 hover:text-black transition-colors duration-200">
                        Contacto
                    </a>
                </nav>
    ...
    <section id="contacto" class="py-20 lg:py-28 bg-white border-t border-gray-200">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 fade-in-up delay-1">
                ...
                <!-- WhatsApp -->
                <a 
                    href="https://wa.me/346XXXXXXXX?text=Hola,%20me%20gustaría%20reservar%20una%20cita%20con%20la%20nutricionista" 
                    target="_blank"
